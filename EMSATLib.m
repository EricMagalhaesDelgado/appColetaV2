...
classdef EMSATLib
    ...
    methods
        ...
        function filepath = create_new_cfg_file(obj)
            ...
            % Main variables            
            Antenna = struct('MCL1', struct('Limits', LIMITS_MCL1, 'LNB', LNB_MCL1, 'ACU', ACU_MCL1), ...
            ...
            writecell({jsonencode(struct('Antenna',     Antenna,  ...
                                         'Matrix',      Matrix,   ...
                                         'UserOptions', UserOptions), 'PrettyPrint', true)}, filepath, "FileType", "text", "QuoteStrings", false)
