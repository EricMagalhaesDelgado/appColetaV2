function Layout(app)
    ...
    switch app.plotLayout
            case 1
                set(app.axes1,          Visible=1, PickableParts='visible')
                ...
                set(app.axes2,          Visible=1, PickableParts='visible')
            ...
            case 2
                ...
                set(app.axes2,          Visible=0, PickableParts='none')
            ...
            case 3
                set(app.axes1,          Visible=0, PickableParts='none')
