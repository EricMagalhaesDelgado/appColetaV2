function warnMsg = receiverConfig_SpecificBand(obj, idx, EMSatObj)
    ...
    rawFields = {'TraceMode',        'AverageMode',     'AveragCount',     ... %  1 a  3
                 ...
                 'FreqCenter',       'FreqSpan',        'DF_MeasMethod',   ... % 22 a 24
                 'DF_MeasTime',      'DF_Threshold',    'DF_ResolutionValue'}; % 25 a 27
    ...
    for ii = 1:numel(rawBand)
        ...
        replaceCell = {'%Trace%',              TraceMode;                 ... 
                       ...
                       '%FreqSpan%',           FreqSpan;                  ...
                       '%DF_MeasMethod%',      DF_MeasMethod;             ...
                       '%DF_MeasTime%',        DF_MeasTime;               ...
                       '%DF_Threshold%',       DF_Threshold;              ...
                       '%DF_ResolutionValue%', DF_ResolutionValue};
